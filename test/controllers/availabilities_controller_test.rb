...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { active: @availability.active, end: @availability.end, seat: @availability.seat, seat_price: @availability.seat_price, space_id: @availability.space_id, start: @availability.start } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { active: @availability.active, end: @availability.end, seat: @availability.seat, seat_price: @availability.seat_price, space_id: @availability.space_id, start: @availability.start } }
